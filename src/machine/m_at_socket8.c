...
int
machine_at_d931_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/d931/omf.bin",
                           0x000e0000, 262144, 0);
    ...
    pci_register_slot(0x02, PCI_CARD_SOUTHBRIDGE,     0, 0, 0, 0);
    pci_register_slot(0x08, PCI_CARD_IDE,             0, 0, 0, 0);
    pci_register_slot(0x0C, PCI_CARD_NORMAL,          3, 2, 4, 1);
    pci_register_slot(0x0D, PCI_CARD_NORMAL,          2, 1, 3, 4);
    pci_register_slot(0x0E, PCI_CARD_NORMAL,          1, 3, 2, 4);
