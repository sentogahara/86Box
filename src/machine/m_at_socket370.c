...
/* VIA Apollo Pro 133T */
int
machine_at_ficfa15t_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/ficfa15t/VBD43.bin",
                           0x000c0000, 262144, 0);
    ...
    if (sound_card_current[0] == SOUND_INTERNAL)
        device_add(&alc100_device); /* ALC200 is not emulated yet */
